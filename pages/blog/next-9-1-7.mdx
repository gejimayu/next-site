...
We've also added a convenient option for you to enable Strict Mode for your
application.
...
If you or your team is not ready to use Strict Mode in your entire application,
that's OK!
