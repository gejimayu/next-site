...
To remedy this, we've built-in polyfills for the three most common APIs we
observed.
...
- [**Fetch API**](https://developer.mozilla.org/en-US/docs/Web/API/Fetch_API) — Replacing: `whatwg-fetch`, `isomorphic-fetch`, `unfetch`, and `isomorphic-unfetch`.
...
The result is up to **18kB of JavaScript eliminated** from your production bundles.
...
<h3>Before</h3>
<Image
caption={'FCP and TTI Before Optimizations'}
captionSpacing={30}
src="/static/blog/next-9-1-7/nextjs-org-before.png"
width={1922 / 2}
height={842 / 2}
/>
<h3>After</h3>
<Image
caption={'FCP and TTI After Optimizations'}
captionSpacing={30}
src="/static/blog/next-9-1-7/nextjs-org-after.png"
width={1922 / 2}
height={842 / 2}
/>
