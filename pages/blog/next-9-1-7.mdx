...
- **[7kB – 24.7kB+ Smaller Client-Side JavaScript Size](#7kb--247kb-smaller-client-side-javascript-size)**: We've optimized application output even futher, shaving 7.5kB off hello world applications. More complex applications will show a savings up to 25kB or more.
...
benefit from a **7kB or more** size reduction.

Basic applications should see a 3-4% application size reduction, and more
advanced applications may see upwards of 6-7% (or more)!
...
[7kB+ reduction](#7kb--247kb-smaller-client-side-javascript-size) in application size.
